          ...
          <div className="col-md-8">
            <div className="row">
              ...
              <form name="sentMessage" validate onSubmit={handleSubmit}>
                ...
                <a href="https://wa.link/lotus24x7" target="_blank" rel="noopener noreferrer" className="btn btn-custom btn-lg">
                <i className="fa fa-whatsapp"></i> WhatsApp Now
                </a>
              </form>
            </div>
          ...
          <div className="col-md-12">
            <div className="row">
              <div className="social">
                <ul>
                  <li>
                  <a href={props.data ? `https://wa.link/lotus24x7` : "#"} target="_blank" rel="noopener noreferrer">
