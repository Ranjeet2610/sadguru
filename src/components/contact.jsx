    ...
    <div>
          ...
          <div className="col-md-8">
            <div className="row">
              ...
              <form name="sentMessage" validate onSubmit={handleSubmit}>
                ...
                <a href="https://wa.link/n2p523" target="_blank" rel="noopener noreferrer" className="btn btn-custom btn-lg">
                <i className="fa fa-whatsapp"></i> WhatsApp Now
                </a>
              </form>
            </div>
          ...
          <div className="col-md-12">
            <div className="row">
              <div className="social">
                <ul>
                  <li>
                  <a href={props.data ? `https://wa.link/n2p523` : "#"} target="_blank" rel="noopener noreferrer">
      ...
      <div id="footer">
        ...
        Disclaimer:- This Website is only for 18+ users. If you are from Telangana, Orissa, Assam, Sikkim,Andhra Pradesh and Nagaland Please leave the website immediately. Be aware of fraudsters, we only deal via WhatsApp. We Only Promote Fantasy Sports. No Real Money Involvement.{" "}
          ...
          <p>
          Copyright © 2025 swastikk.shop .shop - All Rights Reserved.{" "}
            {/* <a href="http://www.templatewire.com" rel="nofollow">
              TemplateWire
            </a> */}
          </p>
